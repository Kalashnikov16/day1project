...
1) extend functionality to update and delete 
2) install postman and do api testing 
3) react app in a separate folder that listens to GET endpoint and shows the data created in data.js of this project 
